...
*** What is Elm?
Elm is an interesting point in the universe of front-end tools. Elm is a programming language which has been designed, along with its tools and libraries, specialize in making front-end programming as pleasant as possible. Some aspects of this decision:
